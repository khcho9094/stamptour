<template>
    <div class="course_box">
        ...
        <div class="area_box" v-if="mingleCode === 'SzActcWN5QXozxDixoG4zQ==' || mingleCode === 'iQxiUpF8ZfaGodRQJ6s0mg==' || mingleCode === 'YQTt4DYGRx7iBHRXs2IlPA==' || mingleCode === 'Nvn2hlG+v6mVAUJsmrbJ8w=='">
