<template>
    <ul class="gift_list">
        <li v-for="(data, idx) in giftData" v-bind:key="idx">
            ...
            <div v-if="(data.user_gift_send_date !== null || data.user_gift_request_date !== null) && data.mingle_gift_request_date !== '' && data.mingle_gift_add_point !== 'AUTH'" class="gift_complete">
              완료
            </div>
